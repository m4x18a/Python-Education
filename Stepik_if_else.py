...
b = 'синий'
y = 'желтый'
if (color_1 != r and color_1 != b and color_1 != y) or (color_2 != r and color_2 != b and color_2 != y):
    print('ошибка цвета')
elif color_1 == color_2 == r:
    print(r)
elif color_1 == color_2 == b:
    print(b)
elif color_1 == color_2 == y:
    print(y)
elif (color_1 == r and color_2 == b) or (color_1 == b and color_2 == r):
    print('фиолетовый')
elif (color_1 == r and color_2 == y) or (color_1 == y and color_2 == r):
    print('оранжевый')
elif (color_1 == y and color_2 == b) or (color_1 == b and color_2 == y):
    print('зеленый')
...
# На числовой прямой даны два отрезка: [a1; b1], [a2; b2]. Напишите программу, которая находит их пересечение. Гарантируется a1 < b1, a2 < b2.
...
a, b, c, d = int(input()), int(input()), int(input()), int(input())
if c - a == d - b or a - c == d - b or c - a == b - d or a - c == b - d:
    print('YES')
else:
    print('NO')
...
a, b, c, d = int(input()), int(input()), int(input()), int(input())
if ((a - c) ** 2 == 4 and (d - b) ** 2 == 1) or ((a - c) ** 2 == 1 and (d - b) ** 2 == 4): 
    print('YES')
else:
    print('NO')
...
# На вход программе подаются две строки текста, содержащие слова "камень", "ножницы" или "бумага". На первой строке записан выбор Тимура, на второй – выбор Руслана. Программа должна вывести результат жеребьёвки, то есть кто победит Тимур, Руслан или они сыграют вничью.
